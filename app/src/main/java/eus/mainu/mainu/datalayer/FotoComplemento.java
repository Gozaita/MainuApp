 ...
 * Clase del modelo de datos Foto Complemento
 */

public class FotoComplemento {
    ...
    public FotoComplemento(int id, String url, boolean visible, int id_complemento, int id_usuario) {
        this.id = id;
        this.url = url;
